...
class AtomEncoder(nn.Module):
    ...
    def __init__(self, emb_dim, feature_dims, sigma_embed_dim):
        ...
        self.num_categorical_features = feature_dims[0] #ok 14
        self.num_scalar_features = feature_dims[1] + sigma_embed_dim #ok 3
...
class BondEncoder(nn.Module):
    ...
    def __init__(self, emb_dim, feature_dims, sigma_embed_dim):
        ...
        self.num_categorical_features = feature_dims[0] #ok 5 (category bonds)
        self.num_scalar_features = feature_dims[1] + sigma_embed_dim #ok 5
        infeat_dim = self.num_categorical_features + self.num_scalar_features
        self.mlp = nn.Sequential(
            nn.Linear(infeat_dim, 2 * emb_dim), nn.ReLU(),
            nn.Linear(2 * emb_dim, emb_dim)
